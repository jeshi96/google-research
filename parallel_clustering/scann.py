...
def main():
  ...
  searcher = scann.scann_ops_pybind.builder(normalized_dataset, 51, "dot_product").tree(num_leaves=nl, num_leaves_to_search=100, training_sample_size=250000).score_ah(2, anisotropic_quantization_threshold=0.2).reorder(100).build()
